 ...
 * the section above.
 */
class Nano33BLEGyroscope: public Nano33BLESensor<Nano33BLEGyroscope>, public Nano33BLESensorBuffer<Nano33BLEGyroscopeData>
{
  public:
    void init(void);
    void read(void);

    const uint32_t READ_PERIOD_MS_C = GYROSCOPE_READ_PERIOD_MS;
};
