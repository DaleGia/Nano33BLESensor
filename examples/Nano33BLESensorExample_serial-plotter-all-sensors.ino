...
void setup()
{
    ...
    Colour = Nano33BLESensor<Nano33BLEColour>::begin();
    Gesture = Nano33BLESensor<Nano33BLEGesture>::begin();
    Pressure = Nano33BLESensor<Nano33BLEPressure>::begin();
    Temperature = Nano33BLESensor<Nano33BLETemperature>::begin();
    MicrophoneRMS = Nano33BLESensor<Nano33BLEMicrophoneRMS>::begin();
